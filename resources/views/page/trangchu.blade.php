                ...
                <div class="col-sm-12">
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">Tìm thấy {{count($sanphamkhuyenmai)}} styles found</p>
                            <div class="clearfix"></div>
                        </div>

                        <div class="row">
                            @foreach($sanphamkhuyenmai as $khuyenmai )
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="image/product/{{$khuyenmai->image}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$khuyenmai->name}}</p>
                                        <p class="single-item-price">
                                            <span>${{number_format($khuyenmai->promotion_price)}}</span>
                                        </p>
                                    </div>
                        ...
                        <div class="row">
                           ...
                           @foreach($new_product as $new )
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="image/product/{{$new->image}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
